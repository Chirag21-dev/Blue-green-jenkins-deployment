pipeline {
    ...
    stages {
        ...
        stage('Deploy MySQL Deployment and Service') {
            steps {
                script {
                    withKubeConfig(caCertificate: '', clusterName: 'devopsshack-cluster', contextName: '', credentialsId: 'k8-token', namespace: 'webapps', restrictKubeConfigAccess: false, serverUrl: 'https://8046282AD807888DE98A67693D39C4D5.gr7.us-east-1.eks.amazonaws.com') {
